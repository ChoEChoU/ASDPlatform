...
checkpoint_dir = "/home/lmtna99/ASDPlatform/mmaction2/scratch/output/eighth/fold5/hr_td"  # Specify your checkpoint directory
...
optimizer = optim.Adam(i3d_model.parameters(), lr=learning_rate, weight_decay=0.1) #weight_decay=0.01
